...
namespace {
struct qt_meta_tag_ZN6DeleteE_t {};
} // unnamed namespace

template <> constexpr inline auto Delete::qt_create_metaobjectdata<qt_meta_tag_ZN6DeleteE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Delete, qt_meta_tag_ZN6DeleteE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Delete::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6DeleteE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6DeleteE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN6DeleteE_t>.metaTypes,
    nullptr
} };
...
void *Delete::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6DeleteE_t>.strings))
